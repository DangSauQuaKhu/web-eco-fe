...
const HeaderComponent = ({ isHiddenSearch = false, isHiddenCart = false }) => {
  ...
  return (
    <div style={{ height: '80px', width: '100%', display: 'flex', background: 'rgb(26, 148, 255)', justifyContent: 'center' }}>
      <WrapperHeader style={{ justifyContent: isHiddenSearch && isHiddenSearch ? 'space-between' : 'unset' }}>
        <Col span={6}>
          <WrapperTextHeader onClick={() => navigate('/')} style={{ cursor: "pointer" }}>Web-Economerce</WrapperTextHeader>
        </Col>
        {!isHiddenSearch && (
          <Col span={14}>
            <div style={{ display: 'flex', }}>
              ...
              {(img !== "") ? (
                <ButtonComponent
                  size="large"
                  styleButton={{ background: 'rgb(13, 92, 182)', border: 'none' }}
